		...
		<form id="register" action="RegisterUser" method="Post">
			<div class="mb-3">
				<label for="username" class="form-label"> <i
					class="fa fa-user icon"></i>Username
			...
			<div class="mb-3">
				<label class="form-label">Gender</label> <select class="form-select"
			...
			<div class="mb-3 form-check">
				<input type="checkbox" class="form-check-input" id="terms"
					...
					for="terms"> Agree to <a href="#" data-bs-toggle="modal"
					data-bs-target="#termsModal"
					style="color: #006fda; text-decoration: underline;">terms and
						conditions</a>
				</label>
			</div>
			<div id="loader"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<ul>
						...
						<li>By registering, you agree to receive communications from
							us.</li>
